...
public:
    ...
    void setupUi(QDialog *DialogQualityManager)
    {
        ...
        DialogQualityManager->resize(1531, 480);
        QFont font;
        font.setBold(true);
        ...
        checkBoxOntop = new QCheckBox(frameTop);
        checkBoxOntop->setObjectName("checkBoxOntop");

        horizontalLayout_3->addWidget(checkBoxOntop);
        ...
        frame0->setFrameShadow(QFrame::Shadow::Raised);
        ...
        frame5->setFrameShape(QFrame::Shape::StyledPanel);
        frame5->setFrameShadow(QFrame::Shadow::Raised);
        ...
        frame6->setFrameShape(QFrame::Shape::StyledPanel);
        frame6->setFrameShadow(QFrame::Shadow::Raised);

        horizontalLayout_2->addWidget(frame6);

        frame7 = new FrameLocalDimmingProfile(frame);
        frame7->setObjectName("frame7");
        frame7->setFrameShape(QFrame::Shape::StyledPanel);
        frame7->setFrameShadow(QFrame::Shadow::Raised);

        horizontalLayout_2->addWidget(frame7);

        frame8 = new FramePQGamma(frame);
        frame8->setObjectName("frame8");
        frame8->setFrameShape(QFrame::Shape::StyledPanel);
        frame8->setFrameShadow(QFrame::Shadow::Raised);

        horizontalLayout_2->addWidget(frame8);

        frame9 = new FrameCTGamma(frame);
        frame9->setObjectName("frame9");
        frame9->setFrameShape(QFrame::Shape::StyledPanel);
        frame9->setFrameShadow(QFrame::Shadow::Raised);
    ...
    void retranslateUi(QDialog *DialogQualityManager)
    {
        ...
        checkBoxOntop->setText(QCoreApplication::translate("DialogQualityManager", "ON TOP", nullptr));
    } // retranslateUi
