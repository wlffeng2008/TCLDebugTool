...
public:
    ...
    void setupUi(QFrame *FrameControl)
    {
        ...
        pushButtonReadLeft->setMinimumSize(QSize(60, 0));
        pushButtonReadLeft->setMaximumSize(QSize(100, 16777215));
        ...
        horizontalSlider_1->setOrientation(Qt::Orientation::Horizontal);
        ...
        spinBox_1->setButtonSymbols(QAbstractSpinBox::ButtonSymbols::PlusMinus);
        spinBox_2 = new QSpinBox(groupBox2);
        spinBox_2->setObjectName("spinBox_2");
        spinBox_2->setGeometry(QRect(180, 150, 80, 22));
        spinBox_2->setButtonSymbols(QAbstractSpinBox::ButtonSymbols::PlusMinus);
        spinBox_3 = new QSpinBox(groupBox2);
        spinBox_3->setObjectName("spinBox_3");
        spinBox_3->setGeometry(QRect(180, 180, 80, 22));
        spinBox_3->setButtonSymbols(QAbstractSpinBox::ButtonSymbols::PlusMinus);
        ...
        horizontalSlider_8->setOrientation(Qt::Orientation::Horizontal);
