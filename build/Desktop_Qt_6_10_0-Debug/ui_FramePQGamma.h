...
public:
    ...
    void setupUi(QFrame *FramePQGamma)
    {
        ...
        hSliderX->setOrientation(Qt::Orientation::Horizontal);
        ...
        labelCurve->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        vSliderY->setOrientation(Qt::Orientation::Vertical);

        verticalLayoutY->addWidget(vSliderY, 0, Qt::AlignmentFlag::AlignHCenter);
        ...
        horizontalLayoutCtrl->addWidget(label, 0, Qt::AlignmentFlag::AlignRight);
