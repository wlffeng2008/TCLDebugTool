...
public:
    ...
    void setupUi(QFrame *FrameEPCCBOOST)
    {
        if (FrameEPCCBOOST->objectName().isEmpty())
            FrameEPCCBOOST->setObjectName("FrameEPCCBOOST");
        ...
        framePanel->setFocusPolicy(Qt::FocusPolicy::StrongFocus);
        framePanel->setStyleSheet(QString::fromUtf8("background-color: rgb(85, 170, 255);"));
        framePanel->setFrameShape(QFrame::Shape::StyledPanel);
        framePanel->setFrameShadow(QFrame::Shadow::Raised);
        ...
        tableView4->setObjectName("tableView4");
        ...
        tableView4->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        pushButtonLoadICfg->setObjectName("pushButtonLoadICfg");

        horizontalLayout_4->addWidget(pushButtonLoadICfg);

        pushButtonSaveICfg = new QPushButton(FrameEPCCBOOST);
        pushButtonSaveICfg->setObjectName("pushButtonSaveICfg");
        ...
        tableView5->setObjectName("tableView5");
        ...
        tableView5->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        tableView6->setObjectName("tableView6");
        ...
        tableView6->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        lineEditMinI->setObjectName("lineEditMinI");
        ...
        lineEditMaxI->setObjectName("lineEditMaxI");
        ...
        comboBoxBits->addItem(QString());
        comboBoxBits->addItem(QString());
        comboBoxBits->setObjectName("comboBoxBits");
        ...
        radioButtonMode1->setObjectName("radioButtonMode1");
        ...
        radioButtonMode2->setObjectName("radioButtonMode2");
