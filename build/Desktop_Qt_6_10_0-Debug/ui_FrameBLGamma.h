...
public:
    ...
    void setupUi(QFrame *FrameBLGamma)
    {
        ...
        pushButtonReset->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        horizontalSliderPoints->setOrientation(Qt::Orientation::Horizontal);
        ...
        horizontalSliderPos->setOrientation(Qt::Orientation::Horizontal);
        ...
        verticalSliderValue->setOrientation(Qt::Orientation::Vertical);

        verticalLayout->addWidget(verticalSliderValue, 0, Qt::AlignmentFlag::AlignHCenter);
