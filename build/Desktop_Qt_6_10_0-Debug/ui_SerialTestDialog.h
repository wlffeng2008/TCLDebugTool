...
public:
    ...
    void setupUi(QDialog *SerialTestDialog)
    {
        ...
        pushButtonScan->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        pushButtonHide->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        pushButtonNew->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        pushButtonDel->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        pushButtonSend->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        pushButtonLog->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        line->setGeometry(QRect(20, 128, 620, 2));
        line->setFont(font1);
