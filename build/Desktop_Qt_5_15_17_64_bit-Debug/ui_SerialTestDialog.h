...
public:
    ...
    void setupUi(QDialog *SerialTestDialog)
    {
        if (SerialTestDialog->objectName().isEmpty())
            SerialTestDialog->setObjectName(QString::fromUtf8("SerialTestDialog"));
        ...
        pushButtonScan->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        pushButtonHide->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        pushButtonDel->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        pushButtonSendAll->setObjectName(QString::fromUtf8("pushButtonSendAll"));
        pushButtonSendAll->setEnabled(false);
        pushButtonSendAll->setGeometry(QRect(210, 710, 101, 30));
        pushButtonSendAll->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        checkBoxLoop->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        checkBoxOpen->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        checkBoxHexCmd->setObjectName(QString::fromUtf8("checkBoxHexCmd"));
        checkBoxHexCmd->setEnabled(true);
        checkBoxHexCmd->setGeometry(QRect(560, 630, 91, 20));
        checkBoxHexCmd->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        radioButtonRegRead->setObjectName(QString::fromUtf8("radioButtonRegRead"));
        radioButtonRegRead->setGeometry(QRect(70, 570, 71, 20));
        radioButtonRegRead->setMinimumSize(QSize(71, 0));
        radioButtonRegRead->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        lineEditWrite->setObjectName(QString::fromUtf8("lineEditWrite"));
        ...
        checkBoxHexData->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        pushButtonLog->setCursor(QCursor(Qt::PointingHandCursor));
        pushButtonLog->setFocusPolicy(Qt::NoFocus);
        checkBoxReply = new QCheckBox(SerialTestDialog);
        checkBoxReply->setObjectName(QString::fromUtf8("checkBoxReply"));
        checkBoxReply->setGeometry(QRect(338, 100, 161, 24));
        checkBoxReply->setCursor(QCursor(Qt::PointingHandCursor));
        lineEditReply = new QLineEdit(SerialTestDialog);
        lineEditReply->setObjectName(QString::fromUtf8("lineEditReply"));
        ...
        checkBoxWriteNotify->setObjectName(QString::fromUtf8("checkBoxWriteNotify"));
        checkBoxWriteNotify->setGeometry(QRect(338, 140, 161, 24));
        checkBoxWriteNotify->setCursor(QCursor(Qt::PointingHandCursor));
        checkBoxHandShake = new QCheckBox(SerialTestDialog);
        checkBoxHandShake->setObjectName(QString::fromUtf8("checkBoxHandShake"));
        checkBoxHandShake->setGeometry(QRect(338, 70, 211, 24));
        checkBoxHandShake->setCursor(QCursor(Qt::PointingHandCursor));
        ...
        spinBoxPackIndex->setObjectName(QString::fromUtf8("spinBoxPackIndex"));
        ...
        checkBoxAutoCnnt->setObjectName(QString::fromUtf8("checkBoxAutoCnnt"));
        checkBoxAutoCnnt->setGeometry(QRect(190, 100, 141, 21));
        checkBoxAutoCnnt->setMinimumSize(QSize(81, 0));
        checkBoxAutoCnnt->setCursor(QCursor(Qt::PointingHandCursor));
