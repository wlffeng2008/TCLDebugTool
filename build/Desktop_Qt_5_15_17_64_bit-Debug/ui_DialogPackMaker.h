...
public:
    ...
    void setupUi(QDialog *DialogPackMaker)
    {
        if (DialogPackMaker->objectName().isEmpty())
            DialogPackMaker->setObjectName(QString::fromUtf8("DialogPackMaker"));
        ...
        lineEditVersi->setObjectName(QString::fromUtf8("lineEditVersi"));
        ...
        lineEditFile1->setObjectName(QString::fromUtf8("lineEditFile1"));
        lineEditFile1->setGeometry(QRect(140, 70, 571, 21));
        lineEditFile2 = new QLineEdit(DialogPackMaker);
        lineEditFile2->setObjectName(QString::fromUtf8("lineEditFile2"));
