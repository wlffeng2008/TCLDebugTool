...
public:
    ...
    void setupUi(QFrame *FrameRegManager)
    {
        if (FrameRegManager->objectName().isEmpty())
            FrameRegManager->setObjectName(QString::fromUtf8("FrameRegManager"));
        FrameRegManager->resize(1581, 600);
        QFont font;
        font.setPointSize(10);
        font.setBold(false);
        FrameRegManager->setFont(font);
        FrameRegManager->setFocusPolicy(Qt::StrongFocus);
        ...
        checkBoxShowRegEx->setObjectName(QString::fromUtf8("checkBoxShowRegEx"));
        ...
        checkBoxSyncRead->setObjectName(QString::fromUtf8("checkBoxSyncRead"));
        ...
        pushButtonSetting->setCursor(QCursor(Qt::PointingHandCursor));
        pushButtonSetting->setFocusPolicy(Qt::NoFocus);
        ...
        labelQuickTip->setObjectName(QString::fromUtf8("labelQuickTip"));
        ...
        lineEditAddCount->setObjectName(QString::fromUtf8("lineEditAddCount"));
