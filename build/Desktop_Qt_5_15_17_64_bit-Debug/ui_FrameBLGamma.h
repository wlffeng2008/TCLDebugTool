...
public:
    ...
    void setupUi(QFrame *FrameBLGamma)
    {
        if (FrameBLGamma->objectName().isEmpty())
            FrameBLGamma->setObjectName(QString::fromUtf8("FrameBLGamma"));
        ...
        checkBoxShowGammaIn->setObjectName(QString::fromUtf8("checkBoxShowGammaIn"));
        ...
        checkBoxShowRemap->setObjectName(QString::fromUtf8("checkBoxShowRemap"));
        ...
        verticalSliderValue->setObjectName(QString::fromUtf8("verticalSliderValue"));
