...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionFirmware->setObjectName(QString::fromUtf8("actionFirmware"));
        ...
        actionPainter->setObjectName(QString::fromUtf8("actionPainter"));
        ...
        pushButtonSerial->setObjectName(QString::fromUtf8("pushButtonSerial"));
        ...
        pushButtonScreenConfig->setObjectName(QString::fromUtf8("pushButtonScreenConfig"));
        pushButtonScreenConfig->setMinimumSize(QSize(0, 50));
        pushButtonScreenConfig->setMaximumSize(QSize(244, 16777215));
        pushButtonScreenConfig->setCursor(QCursor(Qt::PointingHandCursor));
        pushButtonScreenConfig->setFocusPolicy(Qt::NoFocus);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/MWToolBarTestToolIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pushButtonTestTool->setObjectName(QString::fromUtf8("pushButtonTestTool"));
        pushButtonTestTool->setMinimumSize(QSize(0, 50));
        pushButtonTestTool->setMaximumSize(QSize(244, 16777215));
        pushButtonTestTool->setCursor(QCursor(Qt::PointingHandCursor));
        pushButtonTestTool->setFocusPolicy(Qt::NoFocus);
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/MWToolBarScreenConfigIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pushButtonBrightness->setCursor(QCursor(Qt::PointingHandCursor));
        pushButtonBrightness->setFocusPolicy(Qt::NoFocus);
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/MWToolBarBrightnessIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pushButtonPictureControl->setObjectName(QString::fromUtf8("pushButtonPictureControl"));
        pushButtonPictureControl->setMinimumSize(QSize(0, 50));
        pushButtonPictureControl->setMaximumSize(QSize(244, 16777215));
        pushButtonPictureControl->setCursor(QCursor(Qt::PointingHandCursor));
        pushButtonPictureControl->setFocusPolicy(Qt::NoFocus);
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/MWToolBarPictureControlIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pushButtonLightBoardFlash->setObjectName(QString::fromUtf8("pushButtonLightBoardFlash"));
        pushButtonLightBoardFlash->setMinimumSize(QSize(0, 50));
        pushButtonLightBoardFlash->setMaximumSize(QSize(244, 16777215));
        pushButtonLightBoardFlash->setCursor(QCursor(Qt::PointingHandCursor));
        pushButtonLightBoardFlash->setFocusPolicy(Qt::NoFocus);
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/images/MWToolBarLightBoardFlashIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        pushButtonAdjust->setObjectName(QString::fromUtf8("pushButtonAdjust"));
        pushButtonAdjust->setMinimumSize(QSize(0, 50));
        pushButtonAdjust->setMaximumSize(QSize(244, 16777215));
        pushButtonAdjust->setCursor(QCursor(Qt::PointingHandCursor));
        pushButtonAdjust->setFocusPolicy(Qt::NoFocus);
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/images/MWToolBarAdjustIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        frameLBottom->setObjectName(QString::fromUtf8("frameLBottom"));
        frameLBottom->setMinimumSize(QSize(240, 0));
        frameLBottom->setFrameShape(QFrame::StyledPanel);
        frameLBottom->setFrameShadow(QFrame::Raised);
        ...
        labelStatus->setCursor(QCursor(Qt::PointingHandCursor));
        labelStatus->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));

        horizontalLayout_2->addWidget(labelStatus);


        verticalLayout_2->addWidget(frameLBottom, 0, Qt::AlignRight);


        horizontalLayout_3->addWidget(frameRight, 0, Qt::AlignHCenter);
        ...
        menuFixed->setObjectName(QString::fromUtf8("menuFixed"));
