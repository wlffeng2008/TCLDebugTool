...
public:
    ...
    void setupUi(QFrame *FrameDemo)
    {
        if (FrameDemo->objectName().isEmpty())
            FrameDemo->setObjectName(QString::fromUtf8("FrameDemo"));
        ...
        checkBoxSelectArea->setObjectName(QString::fromUtf8("checkBoxSelectArea"));
        ...
        lineEditSrcW->setObjectName(QString::fromUtf8("lineEditSrcW"));
        lineEditSrcW->setGeometry(QRect(600, 70, 60, 21));
        lineEditSrcW->setMaxLength(5);
        lineEditSrcH = new QLineEdit(groupBox);
        lineEditSrcH->setObjectName(QString::fromUtf8("lineEditSrcH"));
        ...
        pushButtonSetEara->setObjectName(QString::fromUtf8("pushButtonSetEara"));
        ...
        checkBoxFullSrceen->setObjectName(QString::fromUtf8("checkBoxFullSrceen"));
