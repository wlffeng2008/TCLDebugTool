...
namespace {
struct qt_meta_tag_ZN19UppercaseHexSpinBoxE_t {};
} // unnamed namespace

template <> constexpr inline auto UppercaseHexSpinBox::qt_create_metaobjectdata<qt_meta_tag_ZN19UppercaseHexSpinBoxE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<UppercaseHexSpinBox, qt_meta_tag_ZN19UppercaseHexSpinBoxE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject UppercaseHexSpinBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QSpinBox::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19UppercaseHexSpinBoxE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19UppercaseHexSpinBoxE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19UppercaseHexSpinBoxE_t>.metaTypes,
    nullptr
} };

void UppercaseHexSpinBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<UppercaseHexSpinBox *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
const QMetaObject *UppercaseHexSpinBox::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *UppercaseHexSpinBox::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19UppercaseHexSpinBoxE_t>.strings))
        return static_cast<void*>(this);
    return QSpinBox::qt_metacast(_clname);
}

int UppercaseHexSpinBox::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
