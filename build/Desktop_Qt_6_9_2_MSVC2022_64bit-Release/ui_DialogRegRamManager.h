...
public:
    ...
    void setupUi(QDialog *DialogRegRamManager)
    {
        ...
        horizontalLayout->addWidget(checkBoxOntop);
        ...
        frameLeft->setFocusPolicy(Qt::FocusPolicy::ClickFocus);
    ...
    void retranslateUi(QDialog *DialogRegRamManager)
    {
        ...
        checkBoxOntop->setText(QCoreApplication::translate("DialogRegRamManager", "ON TOP", nullptr));
    } // retranslateUi
