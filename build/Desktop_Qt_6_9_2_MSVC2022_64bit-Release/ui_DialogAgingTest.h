...
public:
    ...
    void setupUi(QDialog *DialogAgingTest)
    {
        ...
        tableViewReg->setSelectionMode(QAbstractItemView::SelectionMode::NoSelection);
        tableViewReg->setSelectionBehavior(QAbstractItemView::SelectionBehavior::SelectRows);
        ...
        labelFile->setStyleSheet(QString::fromUtf8("background-color: rgb(204, 204, 204);"));
        labelFile->setWordWrap(true);
        label = new QLabel(DialogAgingTest);
        label->setObjectName("label");
        label->setGeometry(QRect(400, 730, 51, 30));
