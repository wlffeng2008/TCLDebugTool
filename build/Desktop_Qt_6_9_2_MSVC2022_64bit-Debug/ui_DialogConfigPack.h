...
public:
    ...
    void setupUi(QDialog *DialogConfigPack)
    {
        if (DialogConfigPack->objectName().isEmpty())
            DialogConfigPack->setObjectName("DialogConfigPack");
        ...
        comboBoxSheets1->setObjectName("comboBoxSheets1");
        ...
        pushButtonAddSheet->setObjectName("pushButtonAddSheet");
        ...
        checkBoxEditable->setObjectName("checkBoxEditable");
        ...
        tableViewRam->setObjectName("tableViewRam");
        ...
        pushButtonGetSavePath->setObjectName("pushButtonGetSavePath");

        horizontalLayout_2->addWidget(pushButtonGetSavePath);

        pushButtonGotoSavePath = new QPushButton(DialogConfigPack);
        pushButtonGotoSavePath->setObjectName("pushButtonGotoSavePath");
        ...
        lineEditTag->setObjectName("lineEditTag");
        ...
        checkBoxHeadChecksum->setObjectName("checkBoxHeadChecksum");

        horizontalLayout_2->addWidget(checkBoxHeadChecksum);

        pushButtonBuildCfg = new QPushButton(DialogConfigPack);
        pushButtonBuildCfg->setObjectName("pushButtonBuildCfg");
